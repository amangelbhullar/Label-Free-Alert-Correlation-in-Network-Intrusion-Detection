#!/usr/bin/env python3
"""
Attack-Type Recovery on CICIDS2017 -- mirrors test_downstream_expanded.py exactly,
just pointed at cicids_alerts.json with 'BENIGN' as the normal-traffic label.
"""
import json
import time
import numpy as np
...
print("\n" + "="*70)
print("BASELINE (full BFS) - CICIDS2017")
print("="*70)
m, h = ci95(base_prec)
...
with open('cicids_attack_type_recovery.json', 'w') as f:
    json.dump(clean(results), f, indent=2)
print("\nSaved cicids_attack_type_recovery.json")
